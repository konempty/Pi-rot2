...
# arcanaPrompt - 37 Two of Cups

Source archive: `../ratio-regeneration/by-card/37_cups_two.md`
Card file: `37_cups_two.png`
Arcana: `minor`

Use case: stylized-concept
Primary request: Two of Cups as scene 2 of the Cups suit story, preserving the existing concept: two gentle young companions in a lavender moonlit garden share exactly two glowing pearl-white cups beside a stream, mutual trust and emotional bond.
Scene/backdrop: moonlit riverside garden with roses, wisteria, distant pearlwater pond, soft moon and pastel sunset glow reflected in water.
Subject and count: EXACTLY TWO CUPS TOTAL, one cup held by each person, both cups meeting near the center. No extra cups, goblets, mugs, bowls, cup-like pendants, cup-shaped lamps, or chalice decorations anywhere else.
Characters: two youthful companions facing each other, one in deep purple cloak and cream clothes, one in pearl-lavender dress with floral hair ornaments. Natural hands and fingers, gentle eye contact.
Pi motif: include a readable purple-and-gold Pi Network inspired charm between the two cups, plus one small Pi seal on each cup stem or rim. The Pi symbol has a top bar, two vertical stems, two small square dots above, and a short attached upturned right hook. No C-shaped loop, no circular right-side hole, no swollen right bulge.
Composition/framing: target portrait art-slot aspect ratio close to 817x1014, about 0.806. Keep both faces, both cups, hands, and Pi charms safely away from the edges with breathing room. No tarot frame, no border, no title, no number, no typography, no watermark.
Constraints: inner illustration only; exact cup count; no readable text, no words, no numbers.
Avoid: extra cups, wrong cup count, malformed Pi symbol, C-shaped Pi icon, animal with human arms, extra fingers, distorted hands, infographic, diagram, poster layout.
