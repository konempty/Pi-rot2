...
# arcanaPrompt - 38 Three of Cups

Source archive: `../ratio-regeneration/by-card/38_cups_three.md`
Card file: `38_cups_three.png`
Arcana: `minor`

Use case: stylized-concept
Primary request: Three of Cups as scene 3 of the Cups suit story, preserving the existing concept: three young friends in a bright lavender fountain garden raise exactly three pearl-white cups together in celebration, community joy and friendship.
Scene/backdrop: sunlit village fountain courtyard with wisteria, roses, fluttering petals, two natural white doves in the sky, aqua fountain spray behind the friends.
Subject and count: EXACTLY THREE CUPS TOTAL, one raised cup held by each of the three friends. The three cups meet near the upper center and are large, separated, and easy to count. No extra cups, goblets, mugs, bowls, teacups, cup-shaped lamps, chalices, or cup-like ornaments anywhere else.
Characters: three youthful companions in pearl-lavender and cream festival clothes, natural hands and fingers, smiling and raising cups. Keep faces and cups readable, not crowded.
Pi motif: include small readable purple-and-gold Pi Network inspired seals on the ribbons or stems of the three cups, plus one pendant on a central character. The Pi symbol has a top bar, two vertical stems, two small square dots above, and a short attached upturned right hook. No C-shaped loop, no circular right-side hole, no swollen right bulge.
Composition/framing: target portrait art-slot aspect ratio close to 817x1014, about 0.806. Keep all faces, all three cups, hands, and Pi symbols safely away from edges with breathing room. No tarot frame, no border, no title, no number, no typography, no watermark.
Constraints: inner illustration only; exact cup count; no readable text, no words, no numbers.
Avoid: extra cups, wrong cup count, cup-shaped tableware, malformed Pi symbol, C-shaped Pi icon, extra fingers, distorted hands, infographic, diagram, poster layout.
