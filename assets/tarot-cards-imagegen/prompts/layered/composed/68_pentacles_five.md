...
# arcanaPrompt - 68 Five of Pentacles

Source archive: `../ratio-regeneration/by-card/68_pentacles_five.md`
Card file: `68_pentacles_five.png`
Arcana: `minor`

Use case: stylized-concept
Primary request: Five of Pentacles as scene 5 of the Pentacles suit story, preserving the existing concept: on a rainy market night, the young coin gardener carries exactly five purple-enamel Pi coinseeds wrapped in cloth while looking toward a warm greenhouse window, hardship with hope.
Scene/backdrop: rainy market alley outside a warm greenhouse or shop window, wet cobblestones, lavender plants, soft lantern reflections.
Subject and strict count: EXACTLY FIVE ROUND PI COINSEED OBJECTS IN THE ENTIRE IMAGE. Arrange five large coinseeds in the open cloth bundle in a clear 2+3 layout. No other round medallions, coin badges, Pi charms, circular tokens, coin-like buttons, or Pi seals anywhere else.
Coinseed style: all five coinseeds share the same style: warm gold rim, deep purple enamel face, clean gold Pi Network inspired emblem with two small square dots above, rounded top bridge/bar, two stems, and a short attached upturned right hook. No C-shaped right loop, no circular right-side hole, no swollen right bulge, no plain gold coin.
Character/anatomy: young gardener holding the cloth bundle with natural hands and fingers, tired but hopeful expression; sprout mascot nearby under a small leaf hood with tiny natural stubby limbs only, no human hands.
Composition/framing: target portrait art-slot aspect ratio close to 817x1014, about 0.806. Keep all five coinseeds, cloth, hands, face, and mascot safely away from edges. No tarot frame, no border, no title, no number, no typography, no watermark.
