...
# arcanaPrompt - 72 Nine of Pentacles

Source archive: `../ratio-regeneration/by-card/72_pentacles_nine.md`
Card file: `72_pentacles_nine.png`
Arcana: `minor`

Use case: stylized-concept
Primary request: Nine of Pentacles as scene 9 of the Pentacles suit story, preserving the existing concept: the young coin gardener walks calmly through a harvest greenhouse path, enjoying self-sufficient abundance among exactly nine purple-enamel Pi coinseeds.
Scene/backdrop: lush greenhouse aisle at golden hour, terraced planters, lavender flowers, soft vines, warm glasshouse light.
Subject and strict count: EXACTLY NINE ROUND PI COINSEED OBJECTS IN THE ENTIRE IMAGE. Arrange nine large coinseeds among plants in a clear 3+3+3 layout along the greenhouse path. No other round medallions, coin badges, Pi charms, circular tokens, coin-like buttons, or Pi seals anywhere else.
Coinseed style: all nine coinseeds share the same style: warm gold rim, deep purple enamel face, clean gold Pi Network inspired emblem with two small square dots above, rounded top bridge/bar, two stems, and a short attached upturned right hook. No C-shaped right loop, no circular right-side hole, no swollen right bulge, no plain gold coin.
Character/anatomy: young gardener walking confidently with natural hands and relaxed expression; sprout mascot nearby with plant leaves and tiny natural stubby limbs only, no human hands.
Composition/framing: target portrait art-slot aspect ratio close to 817x1014, about 0.806. Keep all nine coinseeds, full figure, and mascot safely away from edges. No tarot frame, no border, no title, no number, no typography, no watermark.
