...
# arcanaPrompt - 52 Three of Swords

Source archive: `../ratio-regeneration/by-card/52_swords_three.md`
Card file: `52_swords_three.png`
Arcana: `minor`

Use case: stylized-concept
Primary request: Three of Swords as scene 3 of the Swords suit story, preserving the existing concept: in a rain-lit glass chapel garden, exactly three silver practice swords pierce or cross through a glowing crystal heart-shaped light, symbolizing heartbreak and healing without gore.
Scene/backdrop: moonlit glass chapel, rain on windows, lavender roses, reflective water, soft blue wind ribbons.
Subject and count: EXACTLY THREE SWORDS TOTAL, all large and separated: one vertical central sword and two diagonal side swords crossing the heart-shaped crystal light. No extra swords, daggers, blade ornaments, sword-shaped window mullions, or sharp reflections anywhere else.
Character/anatomy: no injured body. A young academy student may appear small in the lower scene or as a soft silhouette with natural posture, but the three swords and crystal heart remain the focus.
Pi motif: include two or three readable purple-and-gold Pi Network inspired emblems: one small medallion hanging below the crystal heart, one seal on the central sword hilt, and one subtle Pi charm in the rain reflection. The Pi symbol has a top bar, two vertical stems, two small square dots above, and a short attached upturned right hook. No C-shaped loop or circular right-side hole.
Composition/framing: target portrait art-slot aspect ratio close to 817x1014, about 0.806. Keep all three swords, heart light, and Pi symbols safely away from edges. No tarot frame, no border, no title, no number, no typography, no watermark.
Constraints: inner illustration only; exact sword count; no readable text, no words, no numbers.
Avoid: extra swords, wrong sword count, gore, blood, malformed Pi symbol, C-shaped Pi icon, extra fingers, distorted anatomy, infographic, diagram, poster layout.
