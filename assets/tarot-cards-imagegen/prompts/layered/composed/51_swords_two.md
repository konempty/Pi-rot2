...
# arcanaPrompt - 51 Two of Swords

Source archive: `../ratio-regeneration/by-card/51_swords_two.md`
Card file: `51_swords_two.png`
Arcana: `minor`

Use case: stylized-concept
Primary request: Two of Swords as scene 2 of the Swords suit story, preserving the existing concept: a young Moonwind Academy student sits by a moonlit shore, blindfolded, holding exactly two crossed silver practice swords while delaying a difficult choice.
Scene/backdrop: moonlit seaside academy garden, calm water, two paths of wind or mist in the distance, lavender flowers, pale moon reflection.
Subject and count: EXACTLY TWO SWORDS TOTAL, one in each hand, crossed cleanly before the chest. Both blades are fully visible and clearly countable. No extra swords, daggers, blade-like decorations, sword-shaped moonbeams, or sharp reflections anywhere else.
Character/anatomy: one youthful student with natural hands and fingers, blindfold, calm tense posture. A small owl-like wind familiar may perch nearby with feathered wings and talons only, no human arms or hands.
Pi motif: include two or three readable purple-and-gold Pi Network inspired emblems: one pendant at the blindfold ribbon or cloak clasp, one on a small moon charm near the student, and one tiny seal on a sword guard. The Pi symbol has a top bar, two vertical stems, two small square dots above, and a short attached upturned right hook. No C-shaped loop or circular right-side hole.
Composition/framing: target portrait art-slot aspect ratio close to 817x1014, about 0.806. Keep both swords, face, hands, owl, and Pi symbols safely away from edges. No tarot frame, no border, no title, no number, no typography, no watermark.
Constraints: inner illustration only; exact sword count; no readable text, no words, no numbers.
Avoid: extra swords, wrong sword count, malformed Pi symbol, C-shaped Pi icon, owl with human arms, extra fingers, distorted hands, infographic, diagram, poster layout.
