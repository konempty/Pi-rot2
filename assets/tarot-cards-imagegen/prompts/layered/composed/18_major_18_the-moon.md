...
# arcanaPrompt - 18 The Moon

Source archive: `../ratio-regeneration/by-card/18_major_18_the-moon.md`
Card file: `18_major_18_the-moon.png`
Arcana: `major`

Use case: stylized-concept
Primary request: Major Arcana 18, The Moon, as a polished kawaii fantasy anime tarot scene. A young traveler in a deep purple cloak walks along a winding moonlit path between two distant towers, guided by two wolf-like animal companions under a huge crescent moon. The path glows over water and flowers, creating a dreamlike uncertain atmosphere.
Card identity for scene only: dreams, intuition, uncertainty, subconscious path, illusion and guidance.
Composition/framing: vertical portrait inner illustration only, target art-slot ratio 0.806, traveler centered lower half, two wolf-like companions at the sides, crescent moon, towers, path, lantern, and Pi charms comfortably inside the image, generous safe margin for ornate frame and top-center template coin. No tarot card frame, no border, no blank plaque.
Pi motif: use Pi Network-inspired symbols visibly but dreamlike: one gold-and-purple Pi emblem on the traveler's pendant, one small moon-path coin reflection, and a tiny lantern seal. Each emblem should have two small square dots above, a continuous rounded bridge, two vertical stems, and the right side rising into a filled upward hook. Avoid C-shaped loops or circular holes on the right side.
Constraints: no tarot card frame, no UI, no poster layout; keep anatomy natural. The wolf-like companions must have paws only, no human hands, no human arms, no fingers.
Avoid: wrong aspect ratio, cropped moon or animals, animal companions with human arms or hands, malformed Pi mark, C-shaped Pi icon, pig nose, Roman numeral II, number 2, horseshoe, omega, extra fingers, distorted face, readable text, low resolution.
