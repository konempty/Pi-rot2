...
# arcanaPrompt - 66 Three of Pentacles

Source archive: `../ratio-regeneration/by-card/66_pentacles_three.md`
Card file: `66_pentacles_three.png`
Arcana: `minor`

Use case: stylized-concept
Primary request: Three of Pentacles as scene 3 of the Pentacles suit story, preserving the existing concept: the young coin gardener carefully studies exactly three purple-enamel Pi coinseeds on an outdoor garden worktable, learning skilled cultivation with a helper's hand nearby.
Scene/backdrop: high-angle or three-quarter view of a garden worktable beside lush coinseed beds, greenhouse arches, lavender flowers, warm sunset light.
Subject and strict count: EXACTLY THREE ROUND PI COINSEED OBJECTS IN THE ENTIRE IMAGE. Place three large coinseeds across the worktable in a clear row or triangle. No other round medallions, coin badges, Pi charms, circular tokens, coin-like buttons, or Pi seals anywhere else.
Coinseed style: all three coinseeds share the same style: warm gold rim, deep purple enamel face, clean gold Pi Network inspired emblem with two small square dots above, rounded top bridge/bar, two stems, and a short attached upturned right hook. No C-shaped right loop, no circular right-side hole, no swollen right bulge, no plain gold coin.
Character/anatomy: young gardener with natural hands and fingers, focused expression; one helper's hand may point gently at one coinseed but no extra body crowd. Sprout mascot nearby with plant leaves and tiny natural stubby limbs only, no human hands.
Composition/framing: target portrait art-slot aspect ratio close to 817x1014, about 0.806. Keep all three coinseeds, hands, face, and mascot safely away from edges. No tarot frame, no border, no title, no number, no typography, no watermark.
Constraints: inner illustration only; exact count; no readable text, no words, no numbers.
Avoid: extra coins, extra Pi badges, extra round medallions, wrong count, C-shaped Pi icon, right-side bulge, plain gold coin, malformed hands, infographic, diagram, poster layout.
