...
# arcanaPrompt - 71 Eight of Pentacles

Source archive: `../ratio-regeneration/by-card/71_pentacles_eight.md`
Card file: `71_pentacles_eight.png`
Arcana: `minor`

Use case: stylized-concept
Primary request: Eight of Pentacles as scene 8 of the Pentacles suit story, corrected to feel like garden cultivation, not workshop manufacturing: the young coin gardener carefully waters and prunes exactly eight purple-enamel Pi coinseeds growing in terraced garden rows.
Scene/backdrop: outdoor terraced field at warm sunset, greenhouse arches in the background, irrigation channels, lavender flowers, soil rows, no indoor workshop.
Subject and strict count: EXACTLY EIGHT ROUND PI COINSEED OBJECTS IN THE ENTIRE IMAGE. Arrange eight large coinseeds growing from plants in two neat rows of four, 4+4. No other round medallions, coin badges, Pi charms, circular tokens, coin-like buttons, or Pi seals anywhere else.
Coinseed style: all eight coinseeds share the same style: warm gold rim, deep purple enamel face, clean gold Pi Network inspired emblem with two small square dots above, rounded top bridge/bar, two stems, and a short attached upturned right hook. No C-shaped right loop, no circular right-side hole, no swollen right bulge, no plain gold coin.
Character/anatomy: young gardener kneels or leans forward with watering can and pruning shears, natural hands and focused expression; sprout mascot nearby with plant leaves and tiny natural stubby limbs only, no human hands.
Composition/framing: target portrait art-slot aspect ratio close to 817x1014, about 0.806. Keep all eight coinseeds, gardener, tools, and mascot safely away from edges. No tarot frame, no border, no title, no number, no typography, no watermark.
Constraints: inner illustration only; exact count; no readable text, no words, no numbers.
Avoid: indoor workshop, forge, crafting bench, manufacturing coins, extra coins, extra Pi badges, extra round medallions, wrong count, C-shaped Pi icon, right-side bulge, plain gold coin, malformed hands, infographic, diagram, poster layout.
