...
# arcanaPrompt - 44 Nine of Cups

Source archive: `../ratio-regeneration/by-card/44_cups_nine.md`
Card file: `44_cups_nine.png`
Arcana: `minor`

Use case: stylized-concept
Primary request: Nine of Cups as scene 9 of the Cups suit story, preserving the existing concept: private fulfillment at a hidden moonwell garden, a young purple-cloaked cup keeper smiles peacefully before exactly nine filled pearl-white cups displayed behind them.
Scene/backdrop: serene moonwell garden or soft daylight pavilion with lavender wisteria, water reflections, cushions, gentle fulfilled mood.
Subject and count: EXACTLY NINE CUPS TOTAL. Arrange the cups as a simple display: five cups in the back row and four cups in the front row, all large, separated, and fully visible. The cups are the only cup-shaped objects in the image. No other goblets, bowls, jars, teacups, dessert dishes, cup-like lanterns, or chalice decorations.
Character/anatomy: one youthful cup keeper seated calmly below or in front of the nine-cup display, gentle smile, natural hands resting open, no extra fingers.
Pi motif: include a readable purple-and-gold Pi Network inspired pendant on the keeper and small Pi seals on several cup stems. The Pi symbol has a top bar, two vertical stems, two small square dots above, and a short attached upturned right hook. No C-shaped loop or circular right-side hole.
Composition/framing: target portrait art-slot aspect ratio close to 817x1014, about 0.806. Keep all nine cups, face, hands, and Pi symbols safely away from edges with breathing room. No tarot frame, no border, no title, no number, no typography, no watermark.
Constraints: inner illustration only; exact cup count; no readable text, no words, no numbers.
Avoid: eight cups, ten cups, extra cups, cup-like bowls, cup-like lanterns, malformed Pi symbol, C-shaped Pi icon, extra fingers, distorted hands, infographic, diagram, poster layout.
