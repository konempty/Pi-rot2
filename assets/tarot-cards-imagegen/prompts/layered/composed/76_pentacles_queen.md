...
# arcanaPrompt - 76 Queen of Pentacles

Source archive: `../ratio-regeneration/by-card/76_pentacles_queen.md`
Card file: `76_pentacles_queen.png`
Arcana: `minor`

Use case: stylized-concept
Primary request: Queen of Pentacles court archetype, preserving the existing garden abundance concept: a warm, grounded garden queen sits in a golden greenhouse with a basket of thriving purple-enamel Pi coinseeds, nurturing prosperity and practical care.
Scene/backdrop: golden greenhouse interior, vines, flower beds, terraced planters, warm lanterns, peaceful abundance.
Subject: mature feminine Pentacles queen with kind grounded expression, natural hands holding one prominent coinseed or a basket of coinseeds, nurturing posture. Sprout mascot nearby with plant leaves and tiny natural stubby limbs only, no human hands.
...
Composition/framing: target portrait art-slot aspect ratio close to 817x1014, about 0.806. Keep queen, hands, coinseeds, basket, mascot, and greenhouse safely away from edges. No tarot frame, no border, no title, no number, no typography, no watermark.
Constraints: inner illustration only; no readable text, no words, no numbers.
Avoid: C-shaped Pi icon, right-side bulge, plain gold coin, harsh expression, extra fingers, malformed hands, infographic, diagram, poster layout.
