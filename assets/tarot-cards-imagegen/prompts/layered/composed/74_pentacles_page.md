...
# arcanaPrompt - 74 Page of Pentacles

Source archive: `../ratio-regeneration/by-card/74_pentacles_page.md`
Card file: `74_pentacles_page.png`
Arcana: `minor`

Use case: stylized-concept
Primary request: Page of Pentacles court archetype, preserving the existing garden concept but making the figure younger and more apprentice-like: a youthful coinseed page kneels in a golden greenhouse garden, carefully studying one purple-enamel Pi coinseed with wonder.
Scene/backdrop: warm sunset greenhouse path, seedling trays, lavender flowers, open garden notebook, careful tools, soft golden light.
Subject: a clearly young page/apprentice, early teen or youthful face, soft rounder features, bright curious eyes, not mature adult, not queenly or kingly. Natural hands hold one large coinseed near chest height. Sprout mascot nearby with plant leaves and tiny natural stubby limbs only, no human hands.
Pentacle motif: one primary purple-enamel Pi coinseed is large and readable. It has a warm gold rim, deep purple enamel face, clean gold Pi Network inspired emblem with two small square dots above, rounded top bridge/bar, two stems, and a short attached upturned right hook. No C-shaped right loop, no circular right-side hole, no swollen right bulge, no plain gold coin.
Composition/framing: target portrait art-slot aspect ratio close to 817x1014, about 0.806. Keep face, hands, coinseed, notebook, tools, and mascot safely away from edges. No tarot frame, no border, no title, no number, no typography, no watermark.
Constraints: inner illustration only; no readable text, no words, no numbers.
Avoid: mature adult face, seductive pose, extra fingers, malformed hands, C-shaped Pi icon, right-side bulge, plain gold coin, infographic, diagram, poster layout.
