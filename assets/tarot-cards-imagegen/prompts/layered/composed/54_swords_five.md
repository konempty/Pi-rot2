...
# arcanaPrompt - 54 Five of Swords

Source archive: `../ratio-regeneration/by-card/54_swords_five.md`
Card file: `54_swords_five.png`
Arcana: `minor`

Use case: stylized-concept
Primary request: Five of Swords as scene 5 of the Swords suit story, preserving the existing concept: after a tense academy training duel on a misty shore, the young student stands uneasily with exactly five silver practice swords visible, victory feeling uncomfortable.
Scene/backdrop: windy shore near the academy, moonlit clouds and pale dawn, wet sand and blue wind lines, two distant classmates as small silhouettes.
Subject and count: EXACTLY FIVE SWORDS TOTAL. Arrange them clearly: one sword held by the main student, two swords lying on the ground to the left, and two swords lying on the ground to the right. All five are fully visible and countable. No extra swords, daggers, blade-like reflections, spear shapes, sword-like reeds, or sharp decorative lines anywhere else.
Character/anatomy: one youthful student with natural hands and fingers, conflicted expression, standing posture. Distant classmates should not hold swords. A small owl bird familiar may appear with wings and talons only, no human arms or hands.
Pi motif: include two or three readable purple-and-gold Pi Network inspired emblems: one cloak clasp or belt charm, one small seal on the held sword guard, and one moonwind academy token on the ground. The Pi symbol has a top bar, two vertical stems, two small square dots above, and a short attached upturned right hook. No C-shaped loop or circular right-side hole.
Composition/framing: target portrait art-slot aspect ratio close to 817x1014, about 0.806. Keep all five swords, face, hands, owl if present, and Pi symbols safely away from edges. No tarot frame, no border, no title, no number, no typography, no watermark.
Constraints: inner illustration only; exact sword count; no readable text, no words, no numbers.
Avoid: extra swords, wrong sword count, distant people holding swords, malformed Pi symbol, C-shaped Pi icon, owl with human arms, extra fingers, distorted hands, infographic, diagram, poster layout.
