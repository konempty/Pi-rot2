...
# arcanaPrompt - 65 Two of Pentacles

Source archive: `../ratio-regeneration/by-card/65_pentacles_two.md`
Card file: `65_pentacles_two.png`
Arcana: `minor`

Use case: stylized-concept
Primary request: Two of Pentacles as scene 2 of the Pentacles suit story, preserving the existing concept: the young coin gardener balances exactly two purple-enamel Pi coinseeds on a small garden scale beside the terraced market garden.
Scene/backdrop: sunny garden worktable or market stall beside coinseed beds, lavender flowers, greenhouse arches, warm golden light.
Subject and strict count: EXACTLY TWO ROUND PI COINSEED OBJECTS IN THE ENTIRE IMAGE. One coinseed sits on the left scale pan and one coinseed sits on the right scale pan. No other round medallions, coin badges, Pi charms, circular tokens, coin-like buttons, or Pi seals anywhere else.
Coinseed style: both coinseeds share the same style: warm gold rim, deep purple enamel face, clean gold Pi Network inspired emblem with two small square dots above, rounded top bridge/bar, two stems, and a short attached upturned right hook. No C-shaped right loop, no circular right-side hole, no swollen right bulge, no plain gold coin.
Character/anatomy: young gardener adjusting the scale with natural hands and fingers; sprout mascot nearby with plant leaves and tiny natural stubby limbs only, no human hands.
Composition/framing: target portrait art-slot aspect ratio close to 817x1014, about 0.806. Keep both coinseeds, scale, face, hands, and mascot safely away from edges. No tarot frame, no border, no title, no number, no typography, no watermark.
