...
# arcanaPrompt - 70 Seven of Pentacles

Source archive: `../ratio-regeneration/by-card/70_pentacles_seven.md`
Card file: `70_pentacles_seven.png`
Arcana: `minor`

Use case: stylized-concept
Primary request: Seven of Pentacles as scene 7 of the Pentacles suit story, preserving the existing concept: the young coin gardener pauses in a terraced field, waiting patiently as exactly seven purple-enamel Pi coinseeds grow among leaves.
Scene/backdrop: wide terrace garden at sunset, greenhouse in distance, lavender flowers, neat soil rows, warm golden light.
Subject and strict count: EXACTLY SEVEN ROUND PI COINSEED OBJECTS IN THE ENTIRE IMAGE. Arrange seven large coinseeds growing from plants in a clear 4+3 layout across the garden bed. No other round medallions, coin badges, Pi charms, circular tokens, coin-like buttons, or Pi seals anywhere else.
Coinseed style: all seven coinseeds share the same style: warm gold rim, deep purple enamel face, clean gold Pi Network inspired emblem with two small square dots above, rounded top bridge/bar, two stems, and a short attached upturned right hook. No C-shaped right loop, no circular right-side hole, no swollen right bulge, no plain gold coin.
Character/anatomy: young gardener leaning on a small hoe or garden staff, natural hands and patient expression; sprout mascot nearby with plant leaves and tiny natural stubby limbs only, no human hands.
Composition/framing: target portrait art-slot aspect ratio close to 817x1014, about 0.806. Keep all seven coinseeds, gardener, tool, and mascot safely away from edges. No tarot frame, no border, no title, no number, no typography, no watermark.
