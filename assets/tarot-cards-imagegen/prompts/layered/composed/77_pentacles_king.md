...
# arcanaPrompt - 77 King of Pentacles

Source archive: `../ratio-regeneration/by-card/77_pentacles_king.md`
Card file: `77_pentacles_king.png`
Arcana: `minor`

Use case: stylized-concept
Primary request: King of Pentacles court archetype, preserving the existing legacy garden concept: a composed, dependable garden king stands in a prosperous greenhouse courtyard with thriving purple-enamel Pi coinseeds, symbolizing stewardship, wealth, and practical mastery.
Scene/backdrop: golden greenhouse courtyard and garden shop, terraced coinseed beds, warm sunset, lanterns, lavender flowers, stable abundance.
Subject: mature masculine Pentacles king with calm confident expression, natural hands, one prominent coinseed held like a harvest token, rows of coinseeds growing nearby, grounded posture. Sprout mascot nearby with plant leaves and tiny natural stubby limbs only, no human hands.
Pentacle motif: all visible coinseeds use the same style: warm gold rim, deep purple enamel face, clean gold Pi Network inspired emblem with two small square dots above, rounded top bridge/bar, two stems, and a short attached upturned right hook. No C-shaped right loop, no circular right-side hole, no swollen right bulge, no plain gold coins.
Composition/framing: target portrait art-slot aspect ratio close to 817x1014, about 0.806. Keep king, hands, coinseeds, mascot, greenhouse, and garden shop safely away from edges. No tarot frame, no border, no title, no number, no typography, no watermark.
Constraints: inner illustration only; no readable text, no words, no numbers.
Avoid: C-shaped Pi icon, right-side bulge, plain gold coin, harsh tyrant mood, extra fingers, malformed hands, infographic, diagram, poster layout.
