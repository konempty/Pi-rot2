...
# arcanaPrompt - 64 Ace of Pentacles

Source archive: `../ratio-regeneration/by-card/64_pentacles_ace.md`
Card file: `64_pentacles_ace.png`
Arcana: `minor`

Use case: stylized-concept
Primary request: Ace of Pentacles as scene 1 of the Pentacles suit story: a grounded young coin gardener plants exactly one purple-enamel Pi coinseed in a terraced garden at golden hour.
Scene/backdrop: low-angle garden bed with lavender flowers, warm greenhouse light, damp soil, leaves, careful garden tools, small sprout mascot watching.
Subject and strict count: EXACTLY ONE ROUND PI COINSEED OBJECT IN THE ENTIRE IMAGE. The single coinseed is large in the lower center, held or planted by the gardener's hands. There must be no other round medallions, no coin badges, no round Pi charms, no circular tokens, no coin-like buttons, no Pi emblems on clothing, no Pi emblems on the mascot, no circular seals in the background.
Coinseed style: warm gold rim, deep purple enamel face, clean gold Pi Network inspired emblem with two small square dots above, rounded top bridge/bar, two stems, and a short attached upturned right hook. No C-shaped right loop, no circular right-side hole, no swollen right bulge, no plain gold coin, no mathematical pi glyph.
Character/anatomy: warm brown-haired young gardener in green-violet apron and cream shirt, natural hands and fingers, focused gentle expression; sprout mascot has plant leaves and tiny natural stubby limbs only, no human hands.
Composition/framing: target portrait art-slot aspect ratio close to 817x1014, about 0.806. Keep the single coinseed, hands, face, and mascot safely away from edges. No tarot frame, no border, no title, no number, no typography, no watermark.
