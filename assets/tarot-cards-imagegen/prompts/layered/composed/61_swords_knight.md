...
# arcanaPrompt - 61 Knight of Swords

Source archive: `../ratio-regeneration/by-card/61_swords_knight.md`
Card file: `61_swords_knight.png`
Arcana: `minor`

Use case: stylized-concept
Primary request: Knight of Swords court archetype, preserving the improved knight concept: a clearly knightly Moonwind Academy rider charges forward on a translucent blue wind-steed, holding exactly one silver practice sword in a disciplined vow of decisive truth.
Scene/backdrop: high academy courtyard open to rushing clouds, sky temples, blue wind banners, bright brisk morning light.
Subject and sword clarity: one youthful but clearly knightly rider in silver-and-violet wind armor, brave focused expression, dynamic forward diagonal motion. EXACTLY ONE SWORD TOTAL, held upward or forward and fully visible. No extra swords, daggers, weapon piles, sword-shaped banners, blade reflections, or sharp background ornaments.
Animal/companion anatomy: the steed is a translucent magical horse made of blue wind with normal horse form. The owl familiar flies nearby with round owl face, beak, feathered wings, and tiny talons only; no human arms or hands.
Pi motif: include two or three readable purple-and-gold Pi Network inspired emblems: one belt medallion, one small pennant seal, and one saddle charm. The Pi symbol has a top bar, two vertical stems, two small square dots above, and a short attached upturned right hook. No C-shaped loop, no circular right-side hole, no swollen right bulge.
Composition/framing: target portrait art-slot aspect ratio close to 817x1014, about 0.806. Keep rider, wind-steed, single sword, owl, and Pi symbols safely away from edges. No tarot frame, no border, no title, no number, no typography, no watermark.
Constraints: inner illustration only; exact sword count; no readable text, no words, no numbers; no blood, no battle gore.
Avoid: casual adventurer outfit, assassin/rogue look, extra swords, wrong sword count, malformed Pi symbol, C-shaped Pi icon, owl with human arms, extra fingers, distorted hands, infographic, diagram, poster layout.
