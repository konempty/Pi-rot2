...
# arcanaPrompt - 62 Queen of Swords

Source archive: `../ratio-regeneration/by-card/62_swords_queen.md`
Card file: `62_swords_queen.png`
Arcana: `minor`

Use case: stylized-concept
Primary request: Queen of Swords court archetype, preserving the elegant composed concept: a sharp but kind Swords queen sits on a moonlit sky-academy throne with one upright silver sword, clear wisdom, boundaries, and calm discernment.
Scene/backdrop: moonlit sky academy balcony or high tower chamber, open arched window, pale moon, drifting blue wind ribbons, distant spires, crisp air.
Subject and sword clarity: one mature feminine queen with calm violet eyes, elegant violet and cream robes, seated or standing with poised authority. EXACTLY ONE SWORD TOTAL, upright and fully visible. No extra swords, daggers, blade-shaped throne ornaments, sword-like window bars, or sharp reflections anywhere else.
Owl anatomy: small owl bird familiar nearby with round owl face, beak, feathered wings, and tiny talons only. No human arms, no human hands, no pointing fingers, no sleeves, no paws.
Pi motif: include two or three small readable purple-and-gold Pi Network inspired emblems: one crown jewel or hair ornament, one throne seal, and one small sword-pommel seal. Avoid a large chest medallion. The Pi symbol has a top bar, two vertical stems, two small square dots above, and a short attached upturned right hook. No C-shaped loop, no circular right-side hole, no swollen right bulge, no pig-nose shape.
Composition/framing: target portrait art-slot aspect ratio close to 817x1014, about 0.806. Keep queen, one sword, owl, hands, and Pi symbols safely away from edges. No tarot frame, no border, no title, no number, no typography, no watermark.
Constraints: inner illustration only; exact sword count; no readable text, no words, no numbers.
Avoid: C-shaped Pi icon, swollen hook symbol, large chest coin, extra swords, masculine face, harsh cruelty, owl with human arms, extra fingers, distorted hands, infographic, diagram, poster layout.
