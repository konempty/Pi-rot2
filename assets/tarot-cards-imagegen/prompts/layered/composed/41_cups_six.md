...
# arcanaPrompt - 41 Six of Cups

Source archive: `../ratio-regeneration/by-card/41_cups_six.md`
Card file: `41_cups_six.png`
Arcana: `minor`

Use case: stylized-concept
Primary request: Six of Cups as scene 6 of the Cups suit story, preserving the existing concept: after rain, a gentle cup keeper shares a memory with a translucent childlike memory figure in a moonlit seaside garden while exactly six flower-filled cups rest on a stone table.
Scene/backdrop: moonlit seaside garden after rain, distant pearlwater village lights, lotus pond, soft lavender wisteria, calm blue-aqua reflections.
Subject and count: EXACTLY SIX CUPS TOTAL, arranged clearly on the stone table in two rows of three, 3+3. Each cup is pearl-white, filled with flowers or shells, large and separated. No extra cups, goblets, mugs, bowls, teacups, cup-shaped lamps, cup-shaped shell ornaments, or chalice decorations anywhere else.
Characters/anatomy: one gentle youthful cup keeper with lavender-brown hair and pearl hairpin, natural hands; one translucent child memory figure offering a flower, softly ghostlike but with natural child proportions; one tiny water sprite may float nearby with simple fin-like arms only, not human hands.
Pi motif: include a readable purple-and-gold Pi Network inspired pendant on the cup keeper and small Pi seals on two of the six cups. The Pi symbol has a top bar, two vertical stems, two small square dots above, and a short attached upturned right hook. No C-shaped loop, no circular right-side hole, no swollen right bulge.
Composition/framing: target portrait art-slot aspect ratio close to 817x1014, about 0.806. Keep all six cups, faces, hands, and Pi symbols safely away from edges with breathing room. No tarot frame, no border, no title, no number, no typography, no watermark.
Constraints: inner illustration only; exact cup count; no readable text, no words, no numbers.
Avoid: extra cups, wrong cup count, cup-like table ornaments, malformed Pi symbol, C-shaped Pi icon, extra fingers, distorted hands, infographic, diagram, poster layout.
