...
# arcanaPrompt - 39 Four of Cups

Source archive: `../ratio-regeneration/by-card/39_cups_four.md`
Card file: `39_cups_four.png`
Arcana: `minor`

Use case: stylized-concept
Primary request: Four of Cups as scene 4 of the Cups suit story, preserving the existing concept: a young purple-cloaked cup keeper sits under a flowering willow beside the pearlwater stream, quietly contemplating three cups near the ground while a fourth cup is gently offered from a soft cloud-like water spirit.
Scene/backdrop: calm afternoon stream, willow tree and wisteria overhead, distant garden pavilion, reflective pond light, soft petals.
Subject and count: EXACTLY FOUR CUPS TOTAL: three separate pearl-white cups resting on the grass in the lower foreground, and one fourth pearl-white cup floating near the water-spirit cloud. No extra cups, goblets, mugs, bowls, cup-shaped lamps, or cup-like ornaments anywhere else.
Character/anatomy: one seated youthful cup keeper with natural hands and pensive expression. The offering spirit is a soft cloud-and-water swirl with a gentle rounded form, not a human body; avoid creepy human arms, extra hands, or distorted anatomy.
Pi motif: include a readable purple-and-gold Pi Network inspired pendant on the cup keeper and small Pi seals on one or two cups. The Pi symbol has a top bar, two vertical stems, two small square dots above, and a short attached upturned right hook. No C-shaped loop, no circular right-side hole, no swollen right bulge.
Composition/framing: target portrait art-slot aspect ratio close to 817x1014, about 0.806. Keep all four cups, face, hands, and Pi symbols safely away from edges with breathing room. No tarot frame, no border, no title, no number, no typography, no watermark.
Constraints: inner illustration only; exact cup count; no readable text, no words, no numbers.
Avoid: extra cups, wrong cup count, crowd, festival mood, malformed Pi symbol, C-shaped Pi icon, creepy human cloud arm, extra fingers, distorted hands, infographic, diagram, poster layout.
